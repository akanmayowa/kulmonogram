...
<div class="container-fluid">
		  <center>
			...
			<div  id="pdf">
				...
				<div align="center">
					<img src="{{asset('image/logo2.jpg')}}" style="height: 35px; width:35px;"> 
				</div>
			...
			<table width="100%" border="0" cellpadding='2' cellspacing="2" align="center" style="padding-top:4px;">
			<tbody>
				@foreach ($order->transaction as $transactions)
...
<tr><td style="line-height:18px; vertical-align: bottom; text-align: LEFT;">INVOICE NO:               {{$transactions->invoice_id}}
			...
			<tr><td style="line-height:18px; vertical-align: bottom; text-align: LEFT;">ORDER #:      {{$transactions->order_id}}</td></tr>
